...
import { z } from "zod";
import type { Severity } from "../base/index.js";
...
// `src/prose/data-loader.ts` and its compiled `dist/prose/data-loader.js`
// sit at the same depth below the package root, so "../../data/prose"
// resolves correctly whether this runs from source (tests) or from a build.
const PACKAGE_DATA_DIR = fileURLToPath(new URL("../../data/prose", import.meta.url));
